                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td colspan="9" align="center">
                          <img src="<?php echo base_url(); ?>assets/frontend/images/index_042.png" width="500" height="36"></td>
                      <td colspan="2">&nbsp;</td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      ...
                      <?php $secondLapRight = getUserInfo($firstLap['rightmember']); ?>
                        ...
                        <img src="<?= imagePathMyNetwork($secondLapRight['package_list'],60,60); ?>" style="border:none"> <br>
                    ...
                    <tr>
                      ...
                      <?php }else{ ?>
                        <td style="min-width:100px" align="center">
                            <img src="<?= imagePathMyNetwork(array("default"),60,60); ?>" style="border:none"> </td>
                      <?php } ?>
                      ...
                      <?php }else{ ?>
                        <td style="min-width:100px" align="center">
                        <img src="<?= imagePathMyNetwork(array("default"),60,60); ?>" height="60" width="60" style="border:none"> </td>
                      <?php } ?>
